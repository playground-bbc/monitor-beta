...
/**
 * This command will runs emails sends
 *
...
class EmailController extends Controller
{
  ...
  /**
   * This command send email with insights information account client.
  ...
  /**
   *  convert the data into a url for the chart Common words
   *  @param int $alertId 
   *  @return string [ or null]
   */
