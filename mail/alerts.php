...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
   ...
   <body style="background-color:white;">
      <div style="background-color:white;">
                                                ...
                                                <tr>
                                                   <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                      <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                                         <tbody>
                                                            <tr>
                                                               <td style="width:50px;"><img alt="Logo" height="auto" src="https://www.dropbox.com/s/ycqnfcyu931x2ov/logo.png?raw=1" style="background-repeat: no-repeat;background-position: 50%;border-radius: 50%;background-size: 100% auto;display:block;outline:none;text-decoration:none;height:auto;width:100%;" width="50"></td>
                                                            </tr>
                                                         </tbody>
                                                      </table>
                                                   </td>
                                                   ...
                                                   <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:black;font-family:Roboto, Helvetica, Arial, Sans-Serif;font-size:12px;line-height:22px;table-layout:auto;width:100%;border:none;">
                                                         <tr style="border-bottom:1px solid #ccc;padding:15px 0;">
                                                            <th style="width:20%;">Fecha de Creacion de la Alerta</th>
                                                            <th style="width:20%;">Fecha de Inicio de la Alerta</th>
                                                            <th style="width:20%;">Fecha de Final de la Alerta</th>
                                                            <th style="width:20%;">Status de la Alerta</th>
                                                         </tr>
                                                         <tr style="border-bottom:1px solid #ccc;padding:15px 0;">
                                                            <td style="width:20%;text-align:center;"><?= $createdAt ?></td>
                                                            <td style="width:20%;text-align:center;"><?= $start_date ?></td>
                                                            <td style="width:20%;text-align:center;"><?= $end_date ?></td>
                                       ...
                                       <td class="" style="vertical-align:top;width:600px;" >
                                          ...
                                          <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                             <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#f5f5f5;vertical-align:top;" width="100%">
                                                <tr>
                                                   <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                      <div style="font-family:Roboto, Helvetica, Arial, Sans-Serif;font-size:18px;line-height:1;text-align:left;color:black;">Gráfico total de menciones por red social</div>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                       ...
                                       <td class="" style="vertical-align:top;width:600px;" >
                                          ...
                                          <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                             <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#f5f5f5;vertical-align:top;" width="100%">
                                                <tr>
                                                   <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                      <div style="font-family:Roboto, Helvetica, Arial, Sans-Serif;font-size:18px;line-height:1;text-align:left;color:black;">Gráfico de número de interacciones por red social</div>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
         ...
         <?php if(!is_null($hiperLinkIterationByProducts)): ?>   
         <table align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:600px;" width="600" >
            <tr>
               <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
                  <![endif]-->
         ...
         <?php if(!is_null($hiperCommonWords)): ?>   
         <table align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:600px;" width="600" >
            <tr>
               <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
                  <![endif]-->
                                       ...
                                       <td class="" style="vertical-align:top;width:600px;" >
                                          ...
                                          <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                             <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#f5f5f5;vertical-align:top;" width="100%">
                                                <tr>
                                                   <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                      <div style="font-family:Roboto, Helvetica, Arial, Sans-Serif;font-size:18px;line-height:1;text-align:left;color:black;">Gráfico Palabras más comunes en las menciones</div>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                      <a href="<?= "{$frontendUrl}monitor/alert/view?id={$alertId}"?>">
                                                         <img src="<?= $hiperCommonWords ?>" alt="Static Chart"/>
                                                      </a>
                                                   </td>
                                                </tr>
                                             </table>
         ...
         <?php if(!is_null($hiperLinkEmojis)): ?>   
         <table align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:600px;" width="600" >
            <tr>
               <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
                  <![endif]-->
                                       ...
                                       <td class="" style="vertical-align:top;width:600px;" >
                                          ...
                                          <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                             <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#f5f5f5;vertical-align:top;" width="100%">
                                                <tr>
                                                   <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                      <div style="font-family:Roboto, Helvetica, Arial, Sans-Serif;font-size:18px;line-height:1;text-align:left;color:black;">Gráfico Emojis más comunes en las menciones</div>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                      <a href="<?= "{$frontendUrl}monitor/alert/view?id={$alertId}"?>">
                                                         <img src="<?= $hiperLinkEmojis ?>" alt="Static Chart"/>
                                                      </a>
                                                   </td>
                                                </tr>
                                             </table>
